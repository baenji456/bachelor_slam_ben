...
public:
    ...
    pcl::PointCloud<PointType>::Ptr laserCloudRaw; // giseop: Current laser cloud scan raw.
    pcl::PointCloud<PointType>::Ptr laserCloudRawDS; // giseop: Current laser cloud scan down sampled.
